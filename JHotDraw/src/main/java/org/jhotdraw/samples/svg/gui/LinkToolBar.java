...
public class LinkToolBar extends AbstractToolBar {
    ...
    public JComponent disclosedComponentCase( int i){
        ...
        if (i == 1){linkField.setColumns(8);}
        else if (i == 2){linkField.setColumns(12);}      
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        if(i == 1) {gbc.insets = new Insets(3, 0, 0, 0);}
        else if(i == 2){gbc.insets = new Insets(0, 0, 0, 0);}        
        ...
        if(i == 1){targetField.setColumns(4);}
        else if(i == 2){targetField.setColumns(7);}
        ...
        boolean state = false;
        if (i == 1){ state = false;}
        else if(i == 2){ state = true;}
        new FigureAttributeEditorHandler<String>(LINK_TARGET, targetField, editor, state);
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
